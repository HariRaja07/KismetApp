        ...
        <div className="flex w-full max-w-7xl flex-col gap-8 sm:gap-12">
          <div className="flex items-center justify-between">
            <div className="text-4xl flex items-center gap-2">
              <p>Popular In</p>
              <a
                className="border-brand hover:bg-primary-hover flex items-center border-b-2 py-1 text-left transition-colors space-x-1"
                href=""
              >
                <span>Brisbane</span>
          ...
          <div className="grid grid-cols-2 gap-4 xl:grid-cols-3">
            <a
              className="bg-primary hover:bg-primary-hover group grid grid-cols-2 items-center gap-4 rounded-2xl p-4 transition-colors lg:flex"
              href=""
            >
              <div className="text-primary-inverse relative flex h-[244px] w-full flex-col items-center justify-end overflow-hidden rounded-lg p-5 lg:min-w-[154px] lg:max-w-[84px]">
                <img
                  className="bg-primary zoom-on-hover absolute inset-0 h-full w-full object-cover object-center"
                  src={img7}
                  alt="image7"
                />
            ...
            <div className="col-span-2 grid grid-cols-2 gap-4 xl:col-span-1 xl:grid-cols-1">
              <a
                className="bg-primary hover:bg-secondary-hover grid grid-cols-2 items-center gap-4 rounded-2xl p-4 transition-colors"
                href=""
              >
